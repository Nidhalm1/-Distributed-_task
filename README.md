# Dsched, a Peer-to-Peer Request Scheduler
...
Submit work to **any** node, and it will be executed wherever there is capacity:
...
| `--seeds` | *(none)* | Comma-separated bootstrap addresses |
